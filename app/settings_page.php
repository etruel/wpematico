	...
	$helpsettings = array(
		...
		'Advanced Fetching' => array( 
			...
			'allowduplicates' => array( 
				...
				'tip' => __('When the running campaign found a duplicated post the process is interrupted because assume that all followed posts, are also duplicates.  You can disable these controls here.', 'wpematico' ),
