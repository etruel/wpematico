...
(function( $, wp, settings ) {
	...
	$( function() { debugger;
		...
		$document.on( 'credential-modal-cancel', function( event, job ) {
			...
			} else if ( 'plugins' === pagenow || 'plugins-network' === pagenow || pagenow === 'plugins_page_wpemaddons') {
		 ...
		 * @since 4.6.0
		 */
		$pluginInstallSearch.on( 'keyup input', _.debounce( function( event, eventtype ) { debugger;
		 ...
		 * @since 4.6.0
		 */
		$pluginSearch.on( 'keyup input', _.debounce( function( event ) { debugger;
			var data = {
				_ajax_nonce:   wp.updates.ajaxNonce,
				s:             event.target.value,
				pagenow:       pagenow,
		 ...
		 * @since 4.6.0
		 */
		$document.on( 'submit', '.search-plugins', function( event ) { debugger;
			event.preventDefault();
		 ...
		 * @since 4.6.0
		 */
		$( '#typeselector' ).on( 'change', function() { debugger;
		 ...
		 * @param {Event} event Event interface.
		 */
		$( '#plugin_update_from_iframe' ).on( 'click', function( event ) { debugger;
		 ...
		 * @param {Event} event Event interface.
		 */
		$( '#plugin_install_from_iframe' ).on( 'click', function( event ) { debugger;
			var target = window.parent === window ? null : window.parent,
				install;
		 ...
		 * @param {Event} event Event interface.
		 */
		$( window ).on( 'message', function( event ) { debugger;
