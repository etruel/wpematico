...
function wpematico_action_links($data)	{
	...
	return array_merge(	$data,	array(
		...
		'<a href="https://etruel.com/downloads/wpematico-pro/" target="_Blank" title="' . __('View PRO version features', 'wpematico' ) . '">' . __('Go PRO', 'wpematico' ) . '</a>'
	));
}
...
function wpematico_row_meta($data, $page)	{
	...
	return array_merge(	$data,	array(
		...
		'<a href="'.  admin_url('plugins.php?page=wpemaddons').'" target="_self">' . __('Installed Add-Ons') . '</a>',
